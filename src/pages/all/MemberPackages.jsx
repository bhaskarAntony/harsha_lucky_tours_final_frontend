      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12 md:mb-16">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-800 mb-4">
            Member Lucky Draw Packages
          </h1>
          <p className="text-lg md:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Join the excitement! Pay monthly installments and stand a chance to win your dream vacation.
          </p>
          <div className="mt-6 bg-gradient-to-r from-purple-100 to-pink-100 rounded-xl p-5 max-w-2xl mx-auto">
            ...
            <p className="text-gray-700 text-sm md:text-base">
              <strong>One winner every month!</strong> Pay ₹
              {current[0]?.monthlyInstallment?.toLocaleString() || 'X,XXX'}{' '}
              monthly and get a chance to win a fully paid vacation for two.
            </p>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h4 className="font-bold text-gray-800 mb-1">Affordable</h4>
              ...
              <div className="text-center">
                ...
                <h4 className="font-bold text-gray-800 mb-1">Fair Draw</h4>
                <p className="text-sm text-gray-600">
              ...
              <div className="text-center">
                ...
                <h4 className="font-bold text-gray-800 mb-1">Win Big</h4>
                <p className="text-sm text-gray-600">
                  Fully paid trip for two!
                </p>
              </div>
            </div>
            <Link
              to="/register"
              className="mt-8 inline-block bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-8 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105"
            >
